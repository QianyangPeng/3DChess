...
from glLibObjects import glLibObjMap, glLibObjUser, glLibObjText, glLibObjFromFile, glLibObjCube, glLibObjTexCube, glLibObjTeapot, glLibObjSphere, glLibObjTexSphere, glLibObjCylinder, glLibObjTexCylinder, glLibObjTexDisk, glLibObjCapsule, glLibObjCone, glLibObjTexCone
